...
aws cloudformation create-stack --stack-name ecs-eks-resource2 --template-body file://ecr_eks_template.yaml --parameter file://ecr_eks_template.json --region=us-east-1 --capabilities CAPABILITY_NAMED_IAM
