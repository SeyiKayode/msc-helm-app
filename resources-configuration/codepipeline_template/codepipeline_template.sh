...
aws cloudformation create-stack --stack-name create-codepipeline-resource --template-body file://codepipeline_template.yaml --parameter file://codepipeline_template.json --region=us-east-1
